...
folders=[    r'L:\ORGANIZED_DATA\CELL_TIME\20180405_231_REPL\DYES_1khz\r6G_timje\F'
         ]
        ...
        if i.find(".")>-1:
            ...
            if intensity.mean()>0:
                ...
                if data.mean()>0:
                    ...
                    print data[datam].mean(),intensity[datam].mean()#,f1[datam].mean(),a1p[datam].mean()
                    sns.kdeplot(data[datam])
